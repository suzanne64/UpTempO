...
def VelocitySeries(bid,path):
    ...
    # tr=tr.split('\n')
    #
    # outwrite=f'UPTEMPO/WebPlots/VelocitySeries{abbv}L2.png WebPlots/VelocitySeries{abbv}L2.png'
    # if outwrite not in tr:
    #     tr.append(outwrite)
    #     opw=open('UPTEMPO/transferRecord.dat','w')
    #     for t in tr: opw.write(t+'\n')
...
def Batt_Sub(bid,path):
    ...
    # tr=tr.split('\n')
    #
    # outwrite=f'UPTEMPO/WebPlots/Submergence{abbv}L2.png WebPlots/Submergence{abbv}L2.png'
    # if outwrite not in tr:
    #     tr.append(outwrite)
    #     opw=open('UPTEMPO/transferRecord.dat','w')
    #     for t in tr: opw.write(t+'\n')
