...
def PolyList(nors='N'):
    if nors == 'S':
        polypath='/Users/suzanne/Google Drive/UpTempO/PolyPlot2/landbitsS/'
        polyfiles=BT.FileList(polypath)
        
    else:
        polypath='/Users/suzanne/Google Drive/UpTempO/PolyPlot2/'
...
def ArcticMap(rot=0,domain=[-2500.,2500.,-2500.,2500.],fsize=(10,10)):
    ...
    BeringSea = 1
    if BeringSea:
        plt.ylim(domain[2],3500)  # expand the top.
